const Privacy = () => {
    return (<section className="sec-padding">
        <div className="container">
            <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 center  mtpx-50">
            ...
            <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <p>
                        YWe may collect the following information for your identification and
                    ...
                    <ul className="list-simple">
                        <li>
                            Information of clients at Authors Everest is kept extremely secure
                            during transmission by the use of the Secure Sockets Layer (SSL)
                            Software which encrypts information that client puts in.
                        </li>
                        <li>
                            Authors Everest follows generally accepted industry standards to
                            protect the personal information that is being submitted by the
                            client during transmission and once we receive it. However, since no
                            method of transmission over the Internet, or method of electronic
                            storage, is 100% secure, we despite using commercially acceptable
                            means to protect your personal information cannot guarantee its
                            absolute security.
                        </li>
                    </ul>
                    ...
                    <ul className="list-simple">
                        ...
                        <li>
                            Authors Everest utilizes services of credit card processing
                    ...
                    <ul className="list-simple">
                        ...
                        <li>
                            Authors Everest keeps track of your IP address to help diagnose
                            problems with our server and to administer our website. Your IP
                            address is also used to gather broad demographic information about
                            you, such as your location and your Internet service provider.
                        </li>
                        <li>
